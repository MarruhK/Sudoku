...
/**
 * Created by Hamza on 2017-11-10.
 */


/* The class makes use of:
    Overloaded methods
    Collections and manipulation of them
 */
...
public class Board {
    ...
    private void randomizeColumns(){
        ...
        // TESTED HERE AND THE LINESOFTHREE ARRAY IS FINE. THERE IS NO FAULT WITH THE ARRAYS AND ITS VALUES.
        ...
        // AL<int[]> created.
        // Cluster lines have been initialized. The collumns are essentially rows now, so copy steps for randomizing
        //  the rows.
        randomizeRows();
    }

    /**
     * {@code collectionShuffle} consumes an ArrayList that contains ArrayLists of integer arrays, {@code al}, to
     * produce the same ArrayList, but with the ArrayList elements shuffled.
     *
     * It does not shuffle the sub-elements within the ArrayList elements.
     *
     * @param al ArrayList that contains ArrayLists of integer arrays
     */
    ...
    /**
     * {@code initializeLinesOfThrees} consumes nine integer arrays to initialize the box-lines of three instance
     * variables.
     *
     * @param lineOne Integer of array representing a single row
     * @param lineTwo Integer of array representing a single row
     * @param lineThree Integer of array representing a single row
     * @param lineFour Integer of array representing a single row
     * @param lineFive Integer of array representing a single row
     * @param lineSix Integer of array representing a single row
     * @param lineSeven Integer of array representing a single row
     * @param lineEight Integer of array representing a single row
     * @param lineNine Integer of array representing a single row
     */
    ...
    /**
     * {@code initializeLinesOfThrees} consumes an ArrayList of ArrayList of integer array, {@code al}, to initialize
     * the lines of three instance variables.
     *
     * @param al The ArrayList which represents the entire sudoku board.
     */
